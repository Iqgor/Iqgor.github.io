...
actionSpeech = (speechText) => {
  ...
  switch(speechText){ 
    ...
    case "igor":
      window.open("https://www.linkedin.com/in/igor-herrebrugh-10476323a/", "_self");
      break;
    case  "reset":
    ...
    case "iphone":
      ...
      break;
    case "jeroen":
      image1.src = "./img/1633781911017.jpg";
      image1.style.width = "400px";
      image1.classList.remove("hide")
      break;
    case "horloge":
      image1.src = "img/index.jpg"
      image1.style.widows = "400px"
      image1.classList.remove("hide")
      break;
    default:
      window.open("https://www.google.com/search?q=" + speechText , "_self");
      break;
      // do nothing yet
  }
}